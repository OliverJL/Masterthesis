...
big players in the IT-industry like Citrix$^\text{\textregistered}$ or Intel$^\text{\textregistered}$ \cite{xenprjct}; Xen is a Type 1 Hypervisor. For this concept of virtualization, also known as 'Bare Metal Virtualization', the hypervisor application is running directly on the hardware.
