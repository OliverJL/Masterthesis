...
\\~\\
Xen or also Xen-Project is an open source projects developed and maintained by the Linux Foundation
. It originally was started at the University of Cambridge in 2003 and is supported by several 
big players in the IT-industry like Citrix$^\text{\textregistered}$ or Intel$^\text{\textregistered}$ \cite{xenprjct}; Xen is a Type 1 Hypervisor. In this concept of virtualization, also known as Bare Metal Virtualization, the hypervisor application is running directly on the hardware.
