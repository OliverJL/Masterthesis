...
A basic Xen based virtual environment consist at least of the following components. In a productive/commercial environment those components are usually embedded in framework like \gls{openstck} providing a variety of features like identity-, resource- backup-management etc. For this thesis, an experimental setup has been composed consisting of the basic components of a virtual environment.

\subsection{Xen-Hypervisor}
The Xen-Hypervisor is a lightweight software layer (<150,000 lines of code \cite{xenprjct}) managing any kind of requests/responses from or to system hardware.
