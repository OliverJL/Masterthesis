...
submits a request, the input pool extracts data from its internal vector. Those values will not be delivered intermediately but transformed by a SHA1 conditioning procedure \cite{kernlrandmc}.   
