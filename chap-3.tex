...
An entropy pool is a complex data structure dedicated to store generated random values as well as its own state regarding the currently achieved entropy level. 
